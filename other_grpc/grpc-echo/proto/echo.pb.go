...
// The request message — carries a text payload
...
// The response message — echoes back the text
...
const file_proto_echo_proto_rawDesc = "" +
	...
	"\vEchoService\x12-\n" +
	"\x04Echo\x12\x11.echo.EchoRequest\x1a\x12.echo.EchoResponseB#Z!github.com/joss12/grpc-echo/protob\x06proto3"
